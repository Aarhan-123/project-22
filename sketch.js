...
function setup() {
	...
	bob1 = Bodies.circle(300,350,40,bob_options);
	World.add(world,bob1);
   
	bob2 = Bodies.circle(350,350,40,bob_options);
	World.add(world,bob2);
    
	bob3 = Bodies.circle(400,350,40,bob_options);
	World.add(world,bob3);

	bob4 = Bodies.circle(450,350,40,bob_options);
	World.add(world,bob4);

    bob5 = Bodies.circle(500,350,40,bob_options);
	World.add(world,bob5);

    rope1 = new Rope(bob1,roof,-100,0);
	rope2 = new Rope(bob2,roof,-55,0);
	rope3 = new Rope(bob3,roof,-10,0);
	rope4 = new Rope(bob4,roof,45,0);
	rope5 = new Rope(bob5,roof,90,0);
...
function keyPressed(){
	...
	if(keyCode === LEFT_ARROW){
      ...
      Matter.Body.applyForce(bob5,bob5.position,{x:-85,y:50});
	}
}
